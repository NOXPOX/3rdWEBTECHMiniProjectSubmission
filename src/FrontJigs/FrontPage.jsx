...
const FrontPage = () => {
  ...
  return (
    <>
      <MenuNav onNavClick={handleNavClick} username = {username} /> {/* Pass the function property */}
      <DashBoard isOpen={isOpen} setIsOpen={setIsOpen} onDashClick={handleDashClick} username = {username}/>

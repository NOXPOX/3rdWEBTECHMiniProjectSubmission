...
import VisitOtherSideBar from './VisitOtherSideBar';
...
const VisitOtherMap = () => {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', width: '100%' }}>
      ...
      {sidebar && <VisitOtherSideBar onClose={() => setSideBarVisible(false)} selectedNode={selectedNode} setNodes={setNodes} setSelectedNode={setSelectedNode} userName={userName} cardTitle={cardTitle} edges={edges} nodes={nodes}/>} {/* Pass the selected node as a prop */}
    </div>
  );
};

export default VisitOtherMap;

...
const VisitOtherSideBar = ({ onClose, selectedNode, setNodes, setSelectedNode, userName, cardTitle, edges, nodes }) => {
  ...
  // Handle status change not required barely used
...
export default VisitOtherSideBar;
